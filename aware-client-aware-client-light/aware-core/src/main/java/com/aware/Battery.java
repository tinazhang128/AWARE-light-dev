...
public class Battery extends Aware_Sensor {
    ...
    public class Battery_Broadcaster extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.d(Aware.TAG, "电池-收到" + intent.getAction() + " --- " + intent.getExtras());
            // Sync data if receiving sync signal
...
//                Log.d(Aware.TAG, "电池表示收到并发送同步请求");
//
//                SyncRequest.Builder request = (new SyncRequest.Builder()).syncOnce();
